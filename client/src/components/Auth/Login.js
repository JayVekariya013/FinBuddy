    ...
    <div className="min-h-screen flex items-center justify-center bg-gradient-to-r from-green-400 via-blue-500 to-indigo-600">
      <div className="bg-white p-10 rounded-lg shadow-lg w-full max-w-md">
        <div className="text-center mb-8">
          ...
          <h2 className="text-2xl font-semibold text-blue-700 mt-2">Login</h2>
        </div>
        ...
        <form onSubmit={handleSubmit}>
          ...
          <button
            type="submit"
            className={`w-full p-3 text-white rounded focus:outline-none focus:ring-2 focus:ring-blue-500 transition-all duration-300 ${
              loading
